...
import bottled.powers.PocketWatchPower;
...
// Custom potion that grants PocketWatchPower to the player
public class PocketWatch extends CustomPotion {
    public static final String ID = makeID(PocketWatch.class.getSimpleName());
    public static final String POTION_ID = BottledRelicsMod.makeID("PocketWatch");
    private static final PotionStrings potionStrings = CardCrawlGame.languagePack.getPotionString(POTION_ID);
    public static final String NAME = potionStrings.NAME;

    // Constructor: defines potion properties and visual configuration
    public PocketWatch() {
        super(NAME, POTION_ID, PotionRarity.UNCOMMON, PotionSize.JAR, PotionColor.BLUE);
        this.isThrown = false;
    ...
    public void initializeData() {
        ...
        this.description = potionStrings.DESCRIPTIONS[0] + (potency * 3) + potionStrings.DESCRIPTIONS[1];
    ...
    public void use(AbstractCreature target) {
        ...
        if (AbstractDungeon.getCurrRoom().phase == AbstractRoom.RoomPhase.COMBAT) {
            addToBot(new ApplyPowerAction(target, AbstractDungeon.player, new PocketWatchPower(target, potency)));
        }
    }
