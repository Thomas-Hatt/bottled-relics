...
public abstract class BasePotion extends AbstractPotion {
    ...
    public BasePotion(String id, PotionRarity rarity, PotionSize shape, Color liquidColor, Color hybridColor, Color spotsColor) {
        super("", id, rarity, shape, PotionEffect.NONE, liquidColor, hybridColor, spotsColor);
        checkColors();
        initializeData();
    }

    public BasePotion(String id, PotionRarity rarity, PotionSize size, PotionColor color) {
